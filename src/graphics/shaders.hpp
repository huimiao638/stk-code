...
class BacklitShadowedSunLightShader : public ShaderHelperSingleton<BacklitShadowedSunLightShader, float, float, float, float, core::vector3df, video::SColorf>, public TextureRead<Nearest_Filtered, Nearest_Filtered, Nearest_Filtered, Shadow_Sampler>
{
public:
